...
\exo [Level=1,Fight=2,Learn=1,Field=\DéveloppementsLimités,Type=\Colles,Origin=\MP,Solution={$\ell=f'(0)/2$}] d. 
Soit $f\in\sc C^1\b([0,1],\ob R\b)$ telle que $f(0)=0$. 
Déterminer la limite $\ell:=\ds \lim\limits_{n\to\infty}\sum_{k=1}^nf\Q({k\F n^2}\W)$.  
...
\exo [Level=1,Fight=3,Learn=2,Field=\DéveloppementsLimités|\Convexite,Type=\Colles,Origin=\MP] h. 
...
\exo [Level=2,Fight=1,Learn=1,Field=\Séries,Type=\Colles,Origin=\MP] al. 
...
\exo [Level=2,Fight=2,Learn=2,Field=\Séries,Type=\Exercices,Origin=\MP] ao.
...
\exo [Level=2,Fight=2,Learn=1,Type=\Colles,Field=\DéveloppementsLimités,Origin=] dw.  
Développement limité au voisinage de $0$ de $f(x):=\arcsin\b(\exp(-x^2)\b)$. 

\exo [Level=1,Fight=3,Learn=1,Type=\Colles,Field=\DéveloppementsLimités,Origin=] dx. 
...
\exo [Level=1,Fight=2,Learn=2,Type=\Colles,Field=\ThéorèmeDeRolle|\DéveloppementsLimités,Origin=] dy. 
...
\exo [Level=1,Fight=3,Learn=2,Type=\Colles,Field=\DéveloppementsLimités,Origin=] dz. 
...
\exo [Level=1,Fight=3,Learn=2,Type=\Colles,Field=\DéveloppementsLimités,Origin=] ea. 
...
\exo [Level=1,Fight=2,Learn=2,Type=\Colles,Field=\DéveloppementsLimités|\Intégration,Origin=] en. 
...
\exo [Level=2,Fight=3,Learn=1,Type=\Exercices,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)={4\F\sqrt3}x-{x^3\F90\sqrt3}+o_0(x^4)$}] hg. 
Développement limité au voisinage de $0$ de $f(x)=\arccos\ds{\sin x\F x}$ 
à l'ordre $4$. 

\exo [Level=1,Fight=3,Learn=1,Type=\Colles,Field=\DéveloppementsLimités,Origin=] hh. 
...
\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=\sqrt2+{x\F2\sqrt2}-{x^2\F16\sqrt2}+o_0(x^2)$}] hj. 
Calculer un développement limité à l'ordre $2$ de $f(x)=\sqrt{2+\sin x}$ en $0$. 

\exo [Level=1,Fight=0,Learn=0,Type=\TravauxDirigés,Field=\Equivalents,Origin=,Solution={$\lim\limits_{x\to0^+}f(x)=1$}] hk. 
...
\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Limites,Origin=,Solution={$\ell=-2$}] ho. 
Calculer $\ell:=\ds\lim_{x\to0}\Q({1\F x\e^x(x+1)}-{1\F x\cos x}\W)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Limites,Origin=,Solution={$\ell=-{1\F2}$}] hp. 
Calculer $\ell:=\ds\lim_{x\to1}\Q({2\F1-x^2}-{3\F1-x^3}\W)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\Limites,Origin=,Solution={$\ell=0$}]  hq. 
Calculer $\ell:=\ds\lim_{x\to+\infty}\Q(\sqrt{\ln(x^2+1)}-\sqrt{\ln(x^2-1)}\W)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Limites,Origin=,Solution={$\ell=1$}]  hr. 
Calculer $\ell:=\ds\lim_{x\to\e^-}(\ln x)^{\ln(\e-x)}$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Colles,Field=\Limites,Origin=]  hs. 
Calculer $\ell:=\lim_{x\to\infty}\Q(\ch\sqrt{x+1}-\ch\sqrt x\W)^{1/\sqrt x}$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\Limites,Origin=,Solution={$\ell_2:=-1$ et $\ell_1$ n'existe pas (limite $0$ à gauche et $+\infty$ à droite)}]  
ht. Calculer $\ell_1:=\lim_{x\to0}x^2\Q(\e^{1/x}-\e^{1/(x-1)}\W)$ et $\ell_2:=\lim_{x\to+\infty}x^2\Q(\e^{1/x}-\e^{1/(x-1)}\W)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\Limites,Origin=,Solution={$\ell=-1$}]  hu. 
Calculer $\ell:=\ds\lim_{x\to1}\Q({4\F\pi-4\arctan x}+{2\F x-1}\W)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Equivalents,Origin=,Solution={$f(x)\Sim_0{x^3\F3}$}]  hv. 
Trouver un équivalent simple de $\tan x-\sqrt{\tan x^2}$ en $0^+$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\Limites,Origin=,Solution={$\ell=1$}]  hw. 
Calculer la limite $\ell:=\lim_{x\to{\pi\F2}^-}\Q(\Q({\pi\F2}-x\W)\tan x\W)^{\tan x}$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Colles,Field=\Limites,Origin=] hx. 
Calculer la limite $\ell:=\lim_{x\to+\infty}\b(\sh(\ch x)-\ch(\sh x)\b)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Limites,Origin=,Solution={$\ell={a-b\F2}$}]  hy. 
Soit $(a,b)\in\ob R^2$ tel que $a\neq0\neq b$. Calculer $\ell:=\lim_{x\to1}\Q({a\F1-x^a}-{b\F1-x^b}\W)$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Equivalents,Origin=,Solution={$f(x)\Sim_0-{7\F360}x^3$}] hz. 
Trouver un équivalent simple de $\ds{1\F x}-{1\F2}\Q({1\F\sin x}+{1\F\sh x}\W)$ en $0$. 

\exo [Level=1,Fight=2,Learn=0,Type=\TravauxDirigés,Field=\Equivalents,Origin=,Solution={$f(x)\Sim_0-{x^7\F45}$}] ia. 
Trouver un équivalent de $\sin(\sh x)-\sh(\sin x)$ en $0$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Colles,Field=\Limites,Origin=,Solution={$\ell=\e^{2\F\pi}$}] ib. 
Calculer $\ell:=\ds\lim_{x\to+\infty}\Q({\arctan(x+1)\F\arctan x}\W)^{x^2}$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Limites,Origin=,Solution={$\ell={8\F9}$}] ic. 
Determiner la limite $\ell$ de la suite de terme général $u_n=\Q(3\times2^{1/n}-2\times3^{1/n}\W)^n$

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\Limites,Origin=,Solution={$\ell={a^2\F b^2}$}] id. 
Déterminer la limite $\ell:=\lim_{x\to 0\atop x\neq0}{\ln\cos ax\F\ln\cos bx}$ pour $a,b\in\ob R^*$. 
...
\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=1+{x^2\F2}+{5x^4\F24}+{61x^6\F720}+o_0(x^5)$}] if. 
Effectuer un développement limité au voisinage de $0$ pour $f(x)={1\F\cos x}$ à l'ordre $5$.
 
\exo [Level=1,Fight=1,Learn=0,Type=\Cours,Field=\Limites,Origin=,Solution={$\ell=1$}] ig. 
Calculer $\ell:=\lim_{x\to\infty}{\ln(x+1)\F\ln x}$. 
...
\exo [Level=2,Fight=2,Learn=2,Type=\Colles,Field=\SériesNumériques,Origin=] oy. 
...
\exo [Level=2,Fight=0,Learn=0,Type=\Colles,Field=\SériesNumériques,Origin=] ph. 
...
\exo [Level=2,Fight=0,Learn=0,Type=\Colles,Field=\SériesNumériques,Origin=] sn. 
...
\exo [Level=2,Fight=0,Learn=0,Type=\TravauxDirigés,Field=\SériesNumériques,Origin=] tn. 
a) Prouver que
$$
...
\exo [Level=1,Fight=2,Learn=1,Type=\Exercices,Field=\DéveloppementsLimités,Origin=] up. 
Montrer que $\ds\sum_{k=0}^n\e^{k^2}\sim\e^{n^2}$ lorsque $n\to\infty$. 

\exo [Level=1,Fight=1,Learn=1,Type=\Exercices,Field=\DéveloppementsLimités,Origin=] uv. 
Donner un équivalent simple de $\ds\sum_{k=n}^{2n}{1\F k^k}$ lorsque $n\to\infty$. 
 
\exo [Level=1,Fight=0,Learn=1,Type=\Exercices,Field=\DéveloppementsLimités,Origin=] uw. 
...
\exo [Level=2,Fight=0,Learn=0,Type=\TravauxDirigés,Field=\SériesNumériques,Origin=] ux. 
...
\exo [Level=1,Fight=1,Learn=1,Field=\DéveloppementsLimités,Type=\Exercices,Origin=]  wk. 
...
\exo [Level=1,Fight=0,Learn=0,Field=\DéveloppementsLimités,Type=\TravauxDirigés,Origin=,Solution={$\ell=\e^{-x}$}] wn. 
Pour $x\in\ob R$, calculer la limite $\ell:=\ds\lim_{n\to\infty}\Q(1-{x\F n}\W)^n$. 

\exo [Level=1,Fight=0,Learn=0,Field=\Limites,Type=\Colles,Origin=,Solution={$\ell={\pi\F8}$}] wo. 
Calculer la limite $\ell:=\ds\lim_{x\to1}{\arctan(x)^2-\pi^2/16\F x^2-1}$. 

\exo [Level=1,Fight=0,Learn=1,Field=\DéveloppementsLimités,Type=\Exercices,Origin=,Solution={$\ell={1\F3\pi}$}] wp. 
...
\exo [Level=1,Fight=2,Learn=1,Field=\DéveloppementsLimités,Type=\Exercices,Origin=\MP]  xm. 
...
\exo [Level=2,Fight=2,Learn=1,Field=\SériesNumériques,Type=\Colles,Origin=] agi.  
...
\exo [Level=2,Fight=2,Learn=2,Field=\SériesNumériques,Type=\TravauxDirigés,Origin=] aih. 
...
\exo [Level=2,Fight=0,Learn=0,Field=\Séries,Type=\Exercices,Origin=\MP] aly. 
Nature de la série $\ds\sum_{n=1}^\infty{2^n n!\F n^n}$.
...
\exo [Level=1,Fight=2,Learn=0,Type=\Exercices,Field=\DéveloppementsLimités,Origin=,Solution={$\ell={\pi\F4}+{x-1\F4}-{(x-1)^2\F8}+o_1\big((x-1)^2_big)$}] anx. 
Calculer un développement limité à l'ordre $2$ de $f(x)=\arctan\sqrt x$ en $1$. 

\exo [Level=1,Fight=0,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=-{1\F2}+{x\F12}+o_0(x^2)$}] any. 
...
\exo [Level=1,Fight=0,Learn=0,Type=\Exercices,Field=\Equivalents,Origin=,solution={$f(x)\mathop{\sim}\limits_0{ln(x)x^3\F3}$}] aoa. 
...
\exo [Level=1,Fight=2,Learn=0,Type=\Exercices,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=x-{3\F2}x^2+{11\F6}x^3-{25\F12}x^4+o_0(x^4)$}] aoe. 
Effectuer un développement limité au voisinage de $0$ pour  $f(x)={\ln(1+x)\F1+x}$ à l'ordre $4$.

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=-{x^2\F6}-{x^4\F180}+o_0(x^5)$}] aof. 
Effectuer un développement limité au voisinage de $0$ pour $f(x)=\ln{\sin x\F x}$ à l'ordre $5$.

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=1+x^2-{x^3\F2}+{5\F6}x^4-{3\F4}x^5+o_0(x^5)$}] aog. 
Effectuer un développement limité au voisinage de $0$ pour $f(x)=(1+x)^x$ à l'ordre $5$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\DéveloppementsLimités,Origin=, Solution={$f(x)=\e-{\e\F3}x^2+{\e\F30}x^4+o_0(x^5)$}] aoh. 
Effectuer un développement limité au voisinage de $0$ pour  $f(x)=\exp{x\F\tan x}$ à l'ordre $5$.

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=1+{x^2\F6}+{7x^4\F360}+o_0(x^5)$}] aoi. 
Effectuer un développement limité au voisinage de $0$ pour $f(x)={x\F\sin x}$ à l'ordre $5$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=x^2+{2x^4\F3}+{17x^6\F45}+o_0(x^7)$}] aoj. 
Effectuer un développement limité au voisinage de $0$ pour  $f(x)=(\tan x)^2$ à l'ordre $7$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=1+x^2+{x^4\F3}+{x^6\F120}+o_0(x^6)$}] aok. 
Effectuer un développement limité au voisinage de $0$ pour  $f(x)=\e^{x\sin x}$ à l'ordre $6$. 

\exo [Level=1,Fight=1,Learn=0,Type=\Exercices,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=\e-{\e\F2}x+{11\e\F24}x^2+-{7\e\F16}x^3+o_0(x^3)$}] aol. 
Effectuer un développement limité au voisinage de $0$ pour  $f(x)=(1+x)^{1/F x}$ à l'ordre $3$. 

\exo [Level=1,Fight=1,Learn=0,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=,Solution={$f(x)=1+x+{x^2\F2}+{x^3\F6}+o_0(x^3)$}] aom. 
...
\exo [Level=2,Fight=2,Learn=2,Type=\TravauxDirigés,Field=\Surfaces,Origin=Quercia,Solution={$y(x^2+(y-1)^2 + z^2) = z^2$.}] aqo.
...
\exo [Level=1,Fight=1,Learn=2,Type=\TravauxDirigés,Field=\DéveloppementsLimités,Origin=\Lakedaemon,Solution={$\Q\{\eqalign{
	\sin(x)&={1\F\sqrt2}+{x-\pi/4\F\sqrt2}-{(x-\pi/4)^2)\F2\sqrt2}+o_{\pi\F4}\Q((x-\pi/4)^2\W)\cr
	\e^x&=\e^{\pi\F4}\Q(1+(x-\pi/4)+{(x-\pi/4)^2\F 2}\W)+o_{\pi\F4}\Q((x-\pi/4)^2\W)\cr
	\ln(x)&=\ln{\pi\F4}+{4\F\pi}(x-\pi/4)-{8\F\pi^2}(x-\pi/4)^2+o_{\pi\F4}\Q((x-\pi/4)^2\W)\cr
		{1\F x}&={4\F \pi}-{16\F\pi^2}(x-\pi/4)+{64\F\pi^3}(x-\pi/4)^2+o_{\pi\F4}\Q((x-\pi/4)^2\W)}\W.
	$}] aqs.
Calculer un développement à l'ordre $2$ des fonctions suivantes en $x={\pi\F 4}$ : 
$$
