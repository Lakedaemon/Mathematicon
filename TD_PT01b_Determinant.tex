...
\hrule\medskip
Le polynôme caractéristique $P$ d'une matrice carrée $A=(a_{i,j})$ est l'unique polynôme vérifiant
$$
\forall \lambda\in\ob C, \qquad P(\lambda)=\det(A-\lambda\hbox{I}_n).
$$

\noindent$\underline{{\bf Exercice}}${ \bf 4.}  Calculer et factoriser le plolynôme caractéristique de $A:=\pmatrix{2&0&1\cr1&1&1\cr-2&0&-1\cr}$. 
\bigskip

\noindent$\underline{{\bf Exercice}}${ \bf 5.}  Calculer et factoriser le plolynôme caractéristique de $A:=\pmatrix{
-7&3&1&-6
\cr
-6&2&1&-6
\cr
...
\noindent$\underline{{\bf Exercice}}${ \bf 6.}  Calculer le polynôme caractéristique $P_A$ de $A:=\pmatrix{0&1&&\ob O\cr
&\ddots&\ddots&\cr
\ob O&&0&1\cr
