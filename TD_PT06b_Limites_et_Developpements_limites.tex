...
\noalign{\hrule}\cr
Opérations & Limites & DL ou Dévelopement asymptotique& équivalents\cr
\noalign{\hrule}\cr
...
$$
\medskip
\centerline{Théorème de Taylor-Lagrange {\it(à utiliser en dernier recours seulement)}}
\hrule
\medskip
Si $f$ est de classe $\sc C^n$ sur un intervalle contenant $a$,  $f$ admet un DL à l'ordre $n$ en $a$  et 
$$\eqalign {
...
$$
\eject\pagetitretrue
\vglue-10mm\rightline{Spé PT\hfill TD 4: Développements limités}%\hfill \date}
\bigskip
\bigskip\noindent
0) Calculer un développement à l'ordre $2$ des fonctions suivantes en $x={\pi\F 4}$ : 
$$
