...
\centerline{%
	...
	\tikzpicture
	\ifHtml 
		\node[text height=2\LD@dimenb,text width=2\LD@dimenb,tex4ht node/escape=true] (a) {\noindent\smash{\Image[Height=2\LD@dimenb,Width=2\LD@dimenb]{E:/TeX/Mathematicon/Abime.jpg}}}%
	\else
		\ifLD@Inferno@Master@
			\node[text width=\LD@dimena,text height=\LD@dimenb%,draw,line width=2pt,inner sep=0pt
	] (a) at (0,-2) {\noindent\smash{\Image[Width=\LD@dimena,Height=\LD@dimenb]{E:/TeX/Mathematicon/AbimMaster.jpg}}}%
		\else
			\node[text width=\LD@dimena,text height=\LD@dimenb%,draw,line width=2pt,inner sep=0pt
	] (a) at (0,-2) {\noindent\smash{\Image[Width=\LD@dimena,Height=\LD@dimenb]{E:/TeX/Mathematicon/Abime.jpg}}}%
		\fi
	\fi
